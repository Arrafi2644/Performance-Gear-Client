...
const Banner = () => {
    ...
    >
      <SwiperSlide>
        <div className='bg-slide1 bg-cover bg-center h-[350px] flex items-center justify-center text-center pl-10 md:pl-16 lg:pl-20'>
           <div className='space-y-2'>
            ...
            <Link to='/allSportsEquipment' className="btn font-semibold bg-accent hover:text-slate-400">Shop Now</Link>
           </div>
        </div>
        </SwiperSlide>
        {/* <SwiperSlide>
        ...
        <SwiperSlide>
        <div className='bg-slide4 bg-cover bg-center h-[350px] flex items-center justify-center text-center pl-10 md:pl-16 lg:pl-20'>
           <div className='space-y-2'>
            <h2 className=' text-3xl md:text-4xl text-primary font-bold'>Top Picks for Champions</h2>
            <h4 className='text-base font-medium text-third '>Explore our best-selling sports accessories designed for peak performance.</h4>
            <Link to='/allSportsEquipment' className="btn font-semibold bg-accent hover:text-slate-400">Shop Now</Link>
        ...
        <SwiperSlide>
        <div className='bg-slide2 bg-cover bg-center h-[350px] flex items-center justify-center text-center pl-10 md:pl-16 lg:pl-20'>
           <div className='space-y-2'>
            <h2 className=' text-3xl md:text-4xl text-primary font-bold'>Stay Warm, Perform Better</h2>
            <h4 className='text-base font-medium text-third '>Discover premium winter sports gear for skiing, snowboarding, and more.</h4>
            <Link to='/allSportsEquipment' className="btn font-semibold bg-accent hover:text-slate-400">Shop Now</Link>
