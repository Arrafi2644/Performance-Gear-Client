...
const Signup = () => {
    ...
    const { signUpUser, signInWithGoogle, setUser, updateUserNamePhoto } = useContext(AuthContext)
    ...
    const handleSignUpUser = (e) => {
        ...
        signUpUser(email, password)
            ...
            .then(result => {
                ...
                updateUserNamePhoto({ displayName: name, photoURL: photo })
                    .then(() => {
                        const updatedUser = { ...newUser, displayName: name, photoURL: photo };
                        setUser(updatedUser)
                        navigate('/')
                        Swal.fire({
                            position: "center",
